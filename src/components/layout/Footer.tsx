    ...
    <footer className="relative min-h-[480px] flex flex-col justify-end overflow-hidden pb-6 pt-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-3xl">
            ...
            <h2 className="font-headline text-2xl md:text-4xl mb-0 leading-tight text-black">
              Your unforgettable <br className="hidden md:block" /> 
              Sri Lankan journey starts here.
            </h2>
          </div>
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-8 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300 fill-mode-both">
        <div className="bg-black/50 backdrop-blur-md rounded-2xl p-6 md:p-8 overflow-hidden border border-white/10 shadow-2xl transition-all duration-500 hover:bg-black/60 group">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 text-white/90">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-xs leading-relaxed max-w-sm mb-6 text-white/70 font-light">
            ...
            <div className="flex flex-col">
              ...
              <nav className="grid grid-cols-2 gap-y-1.5 text-xs font-medium">
        ...
        <div className="mt-4 pb-4 px-4 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] font-bold tracking-[0.2em] uppercase text-white/70 animate-in fade-in duration-1000 delay-700 fill-mode-both">
          ...
          <div className="flex gap-8">
            ...
            <Link href="#" className="hover:text-white hover:underline transition-all underline-offset-4">Terms & Conditions</Link>
          </div>
        </div>
      </div>
    </footer>
