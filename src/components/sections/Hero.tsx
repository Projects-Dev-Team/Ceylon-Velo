  ...
  return (
    <section className="relative h-screen w-full flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 flex flex-col items-start mt-20">
        ...
        <h1 className="font-headline text-5xl md:text-8xl text-white max-w-3xl leading-tight mb-6 italic animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-200 fill-mode-both">
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-600 fill-mode-both">
          <Button 
            className="rounded-none bg-accent text-white hover:bg-accent/90 px-8 h-14 text-sm font-bold tracking-widest transition-transform hover:scale-105"
          >
            EXPLORE SRI LANKA
          </Button>
          <Button 
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-10 right-12 z-10 flex flex-col items-center animate-bounce hidden md:flex animate-in fade-in duration-1000 delay-1000 fill-mode-both">
