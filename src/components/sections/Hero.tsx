    ...
    <section className="relative h-screen w-full flex items-center overflow-hidden bg-[#0A1A17]">
      ...
      >
        ...
        <motion.p variants={fadeUpVariant} className="text-white/90 text-lg md:text-xl max-w-lg mb-10 font-light">
          Discover Sri Lanka through tailor-made journeys,
          handpicked luxury stays, authentic local experiences, and unforgettable memories crafted exclusively for you.
        </motion.p>
        ...
        <motion.div variants={fadeUpVariant} className="flex flex-col sm:flex-row gap-4">
          <Button
            ...
            asChild
          >
            <Link href="/tours">PLAN YOUR JOURNEY<ArrowRight className="w-4 h-4 ml-2" /></Link>
          </Button>
          <Button
            variant="outline"
            ...
            asChild
          >
            <Link href="/villas">EXPLORE EXPERIENCES <ArrowRight className="w-4 h-4 ml-2" /></Link>
          </Button>
        </motion.div>
      </motion.div>
